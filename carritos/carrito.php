...
function  Eliminar_id(id) {
  ...
  {
    window.location.href='Eliminarcarrito.php?idEliminar='+id;
  } 
}
    ...
    <div class="row">
      ...
      <div class="col-9">
        ...
        <tbody>
            ...
            $dulce = new Dulces();
            $resultado = $dulce->obtenercarrito();
            ...
            if(count($resultado)>0){
              foreach($resultado as $registro){
                ...
                <tr>
                  ...
                  <td><a href="Registrarcompra.php"><img src="../img/pedido.png" alt="" width=30px height=30px></a> <p>Hacer pedido</p></td>
                  <td><a href="detalle2.php"><img src="../img/imagen.png" alt="" width=30px height=30px></a> <p>ver</p></td>
                </tr>
                <?php
              }
            }
