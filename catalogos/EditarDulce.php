...
if(isset($_SESSION['usuario'])){
  ...
  $idDulce=$_GET['idEditar'];
  if(isset($_GET['idEditar'])){
      require_once '../Modelos/dulce.php';
      $dulce= new Dulces();
      
      $resultado=$dulce->ObtenerDulceId($idDulce);
          ...
          <div class="card-body p-md-5">
            <div class="row justify-content-center">
              <div class="col-md-1 col-lg-1 col-xl-7 order-6 order-lg-10">
                    ...
                    <form name="login" action="../catalogos/ModificarDulce.php" method="post">
                    <div  class="d-flex flex-row align-items-center mb-3">
                    <i ><img src="../img/Id.png" alt="" width=30px height=30px></i>
                    <input type="text" id="form3Example1c" class="form-control" 
                    placeholder="Id" name="Id" readonly  value="<?php echo $idDulce ?>">
                    </div>
                    <div  class="d-flex flex-row align-items-center mb-3">
                    <i ><img src="../img/Dulce.png" alt="" width=30px height=30px></i>
                    <input type="text" id="form3Example1c" class="form-control" 
                    placeholder="Dulce" name="Dulce" value="<?php echo $Dulce?>">
                    </div>
                    <div  class="d-flex flex-row align-items-center mb-3">
                    <i ><img src="../img/descripcion.png" alt="" width=30px height=30px></i>
                    <input type="text" id="form3Example1c" class="form-control" 
                    placeholder="Descripcion" name="Descripcion" value="<?php echo $Descripcion?>">
                    </div>
                    <div  class="d-flex flex-row align-items-center mb-3">
                    <i ><img src="../img/Precio.png" alt="" width=30px height=30px></i>
                    <input type="text" id="form3Example1c" class="form-control" 
                    placeholder="Precio" name="Precio" value="<?php echo $Precio?>">
                    </div>
                    ...
                    <input type="text" id="form3Example1c" class="form-control" 
                    placeholder="Existencia" name="Existencia" value="<?php echo $Existencia?>">
                    </div>
